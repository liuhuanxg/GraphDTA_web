"""
Django settings for GraphDTA_web project.
...
ROOT_URLCONF = 'GraphDTA_web.urls'
...
WSGI_APPLICATION = 'GraphDTA_web.wsgi.application'
...
# 用户上传文件的存储路径
MEDIA_URL = 'GraphDTA/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'GraphDTA')
